        ...
        return (
          ...
          >
            ...
            <p style={{ color: 'var(--text-secondary)', marginBottom: 30 }}>
              Per creare il tuo programma perfetto, l'AI ha bisogno di conoscerti meglio. Rispondi a
              qualche veloce domanda per calibrare i tuoi allenamenti.
            </p>
          </motion.div>
        );
      case 2:
          ...
          >
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleChange('training_days_per_week', e.target.value)}
                min="1"
                max="7"
                placeholder="es. 4"
                className="glass-input"
        ...
        return (
          ...
          >
            ...
            <div className="form-group">
              ...
              <select
                value={formData.gym_equipment}
                onChange={(e) => handleChange('gym_equipment', e.target.value)}
                className="glass-input"
              >
                <option value="">Seleziona...</option>
        ...
        return (
          ...
          >
            ...
            <p style={{ color: 'var(--text-secondary)', marginBottom: 20 }}>
              KineFit AI può usare i dati del tuo smartwatch per calibrare il recupero (HRV, Sleep
              Score, Stress).
            </p>
            <div
              className="setting-card glass-panel"
              style={{
                display: 'flex',
              ...
              onClick={() => handleChange('garmin_connected', !formData.garmin_connected)}
            >
              <div>
                <h3 style={{ margin: 0, display: 'flex', alignItems: 'center', gap: 8 }}>
                  <img
                    src="https://upload.wikimedia.org/wikipedia/commons/2/25/Garmin_logo.svg"
                    alt="Garmin"
                    style={{ height: 16, filter: 'invert(1)' }}
                  />
                  Connetti Garmin
                </h3>
            ...
            {formData.garmin_connected && (
              ...
              >
                <p style={{ margin: 0, fontSize: '0.9rem', color: '#007cc3' }}>
                  Mock-up: La connessione OAuth ufficiale verrà implementata. Per ora, il tuo
                  Vivoactive 5 è simulato come connesso.
                </p>
              </motion.div>
            )}
          </motion.div>
