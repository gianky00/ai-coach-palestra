...
const REQUIRED_TEST_IDS: { id: string; hint: string }[] = [
  ...
  { id: 'analytics-week-selector', hint: 'Analytics week selector' },
  { id: 'analytics-week-label', hint: 'Analytics week selector' },
  { id: 'analytics-week-prev', hint: 'Analytics week selector' },
  { id: 'analytics-week-next', hint: 'Analytics week selector' },
  { id: 'analytics-week-loading', hint: 'Analytics week loading' },
  ...
  { id: 'settings-section-allenamento', hint: 'SettingsModal' },
  { id: 'settings-section-sistema', hint: 'SettingsModal' },
...
describe('viewContracts — testID su ogni vista', () => {
  ...
  it('espone history session duration badges dinamici (history-session-duration-*)', () => {
