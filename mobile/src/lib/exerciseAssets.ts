...
export function getExerciseAsset(name: string): string {
  ...
  if (cleanName.includes('lat machine presa inversa'))
    return '/assets/exercises/lat_machine_presa_inversa.jpg';
  ...
  if (cleanName.includes('calf'))
    return cleanName.includes('seduto')
      ? '/assets/exercises/calf_seduto.jpg'
      : '/assets/exercises/calf_in-piedi.jpg';
...
export function getExerciseGuide(name: string, muscleGroup: string): string[] {
  ...
  if (muscleGroup) {
    ...
    if (
      cleanGroup.includes('gambe') ||
      cleanGroup.includes('glutei') ||
      cleanGroup.includes('cosce') ||
      cleanGroup.includes('ipertrofia')
    ) {
